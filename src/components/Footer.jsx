        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-base font-bold text-slate-900 dark:text-white tracking-tight">INOVEXIA</span>
            </div>
        ...
        <div className="pt-8 border-t border-slate-200 dark:border-white/5">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-slate-400 text-center md:text-left">
              © 2026 Inovexia. Tous droits réservés.
            </p>
            <div className="flex gap-6 text-xs text-slate-400">
              <a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Confidentialité</a>
              <a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Conditions</a>
