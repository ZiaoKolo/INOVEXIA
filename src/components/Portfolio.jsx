...
const projectsData = [
  {
    ...
    fullDescription: 'Inovexia a conçu une application Android professionnelle pour moderniser la gestion des maquis et restaurants locaux. Cette solution hors ligne permet une gestion complète du stock, des ventes et offre des statistiques détaillées sans nécessiter de connexion Internet.',
  ...
  },
  {
    ...
    fullDescription: 'Inovexia a créé un assistant culinaire innovant combinant intelligence artificielle et design moderne. La plateforme aide les utilisateurs à transformer leurs ingrédients en délicieux plats tout en valorisant la richesse gastronomique africaine.',
  ...
  },
  {
    ...
    fullDescription: 'Inovexia a développé une plateforme e-commerce moderne dédiée aux fournitures scolaires, combinant une API Django robuste avec une interface React fluide pour une expérience d\'achat optimale.',
  ...
  },
  {
    ...
    fullDescription: 'Inovexia a conçu une extension Chrome intelligente qui révolutionne la gestion de la concentration. En analysant le contenu web en temps réel, elle aide les utilisateurs à rester focusés sur leurs objectifs.',
